...
function checkPassword(form) { 
                ...
                password2 = form.apassword.value; 
                ...
                // If same return True. 
                    ...
                    alert("Sign up Successfull!! Welcome to EL-Commercio!") 
                    return true; 
                } 
            } 
...
function addToCartClicked(event) {
    ...
    var title = shopItem.getElementsByClassName('MName')[0].innerText
    var price = shopItem.getElementsByClassName('MPrice')[0].innerText
    var imageSrc = shopItem.getElementsByClassName('MitemImg')[0].src
